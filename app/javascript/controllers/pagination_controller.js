...
export default class extends Controller {
  ...
  #makeButton(id, text) {
    const li = document.createElement("li");
    li.className =
      "relative inline-flex items-center justify-center rounded-md w-10 h-10 text-gray-400 ring-1 ring-gray-300 ring-inset hover:bg-gray-50 focus:z-20 focus:outline-offset-0 cursor-pointer";
    li.id = id;
    li.textContent = text;
    li.dataset.action =
      "click->calc-results-page#showPage click->records-page#showPage click->pagination#showPagination";
